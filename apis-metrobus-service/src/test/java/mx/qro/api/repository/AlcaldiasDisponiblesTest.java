...
@SpringBootTest
public class AlcaldiasDisponiblesTest {

	/**
	 * Variable LOGGER de tipo Logger
	 */
	public static final Logger LOG = 
			LoggerFactory.getLogger(AlcaldiasDisponiblesTest.class);
	...
	public void buscaUnidadesSinAlcaldia() {
		List<Alcaldia> alcaldias = iUbicacionMetrobusRepository
				.encuentraAlcaldiasDisponibles();
		LOG.info("Alcaldias Disponibles: {}", alcaldias.size());
	}
}
