...
@SpringBootTest
public class CuentaAlcaldiasTest {

	/**
	 * Variable LOGGER de tipo Logger
	 */
	public static final Logger LOG = 
			LoggerFactory.getLogger(CuentaAlcaldiasTest.class);
	...
	public void buscaUnidadesSinAlcaldia() {
		Integer a = iUbicacionMetrobusRepository.cuentaAlcaldias(1);
		LOG.info("Alcaldias: {}", a);
		a = iUbicacionMetrobusRepository.cuentaAlcaldias(2);
		LOG.info("Alcaldias: {}", a);
		a = iUbicacionMetrobusRepository.cuentaAlcaldias(3);
		LOG.info("Alcaldias: {}", a);
	}
}
